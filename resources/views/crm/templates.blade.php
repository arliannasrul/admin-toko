                    ...
                    @forelse ($recentOrders as $ro)
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <a href="{{ route('crm.templates', ['order_id' => $ro->id]) }}" class="button primary" style="padding: 6px 12px; min-height: auto; font-size: 0.85rem; display: inline-flex; align-items: center; gap: 5px;">
                                    <svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="2" fill="none"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> Muat Template
                                </a>
                            </td>
                        </tr>
                    @empty
